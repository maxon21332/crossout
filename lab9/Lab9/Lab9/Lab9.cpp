 ...
 /*   //Вывод списка смежности
    ...
    do
    {
        ...
        case 1:
            ...
            for (i = 0; i < ver; i++)
            {
                cout << "Расстояние от вершины " << ver1 << " до вершины " << i + 1 << " = " << visit[i] << endl;
            }
        ...
        case 2:
            ...
            do
            {
                ...
                if (MassSpis[ver2-1] == 0 ) { cout << "Вершина " << ver2 << " изолированная! Введите другую начальную вершину." << endl;}
                else  prov2 = false;
            } while (prov2);
            ...
            for (i = 0; i < ver; i++)
            {
                cout << "Расстояние от вершины " << ver2 << " до вершины " << i + 1 << " = " << visit[i] << endl;
            }
            TT = (double)(end - start) / CLOCKS_PER_SEC;
            cout << "Время: " << TT << " сек.";
            cout << endl;
        ...
        case 3:
                ...
                if (cin.fail() || (ver3 < 1 || ver3 > ver)) 
                {
                    ...
                    for (i = 0; i < ver; i++)
                    {
                        ...
                        if (smej[ver3 - 1][i] == 1 || smej[i][ver3 - 1] == 1)
                        {
                            ...
                            cout << "Вершина " << ver3 << " изолированная! Введите другую начальную вершину." << endl;
                    }
            } while (prov3);
            ...
            for (i = 0; i < ver; i++)
            {
                cout << "Расстояние от вершины " << ver3 << " до вершины " << i + 1 << " = " << visit[i] << endl;
            }
            TT = (double)(end - start) / CLOCKS_PER_SEC;
            cout << "Время: " << TT << " сек.";
            cout << endl;
        ...
        case 4:
            ...
            do
            {
                ...
                else if (MassSpis[ver4-1] == 0)  cout << "Вершина " << ver4 << " изолированная! Введите другую начальную вершину." << endl;
                else  prov4 = false;
            } while (prov4);
            ...
            for (i = 0; i < ver; i++)
            {
                cout << "Расстояние от вершины " << ver4 << " до вершины " << i + 1 << " = " << visit[i] << endl;
            }
            TT = (double)(end - start) / CLOCKS_PER_SEC;
            cout << "Время: " << TT << " сек.";
            cout << endl;
